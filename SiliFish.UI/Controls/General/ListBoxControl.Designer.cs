namespace SiliFish.UI.Controls
{
    partial class ListBoxControl
    {
        ...
        private void InitializeComponent()
        {
            ...
            // contextMenuListBox
            // 
            contextMenuListBox.Items.AddRange(new ToolStripItem[] { miEditItem, miAddItem, miDeleteItem, miCreateCopy, sepActive, miActivate, miDeactivate, miActivateAll, miDeactivateAll, sepShow, miHideInactive, miShowAll, sepSort, miSortAlphabetically, splitExport, miExport, miImport, sepPlot, miPlot });
            contextMenuListBox.Name = "contextMenuListBox";
            contextMenuListBox.Size = new Size(174, 342);
