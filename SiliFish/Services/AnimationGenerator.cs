...
{
    internal class AnimationGenerator: VisualsGenerator
    {
        ...
        public string CreateTimeSeries(string title, Dictionary<string, Coordinate[]> somiteCoordinates, double[] Time, int timeStart, int timeEnd, int offset)
        {
            ...
            html.Replace("__TIME_INCREMENT__", SwimmingModel.dt.ToString());
